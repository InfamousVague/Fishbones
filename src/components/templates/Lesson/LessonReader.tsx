...
import DeviceAction from "@/components/organisms/Ledger/DeviceAction";
import { useT } from "@/i18n/i18n";
import LedgerStatusPill from "@/components/organisms/Ledger/LedgerStatusPill";
...
export default function LessonReader({
  ...
  useEffect(() => {
    ...
    for (const el of deviceActions) {
      ...
      let config: import("@/components/organisms/Ledger/DeviceAction").DeviceActionConfig | null = null;
      try {
        const raw = decodeB64(b64);
        config = JSON.parse(raw) as import("@/components/organisms/Ledger/DeviceAction").DeviceActionConfig;
      } catch (err) {
